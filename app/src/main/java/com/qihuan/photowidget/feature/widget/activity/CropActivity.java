...
public class CropActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        boolean isFreestyleCrop = intent.getBooleanExtra(UCrop.Options.EXTRA_FREE_STYLE_CROP, OverlayView.DEFAULT_FREESTYLE_CROP_MODE != OverlayView.FREESTYLE_CROP_MODE_DISABLE);
        if (isFreestyleCrop) {
    ...
    private void processOptions(@NonNull Intent intent) {
        ...
        mCompressQuality = intent.getIntExtra(UCrop.Options.EXTRA_COMPRESSION_QUALITY, CropActivity.DEFAULT_COMPRESS_QUALITY);
